        ...
        if (!Constants.IS_ENABLE_LOGIN_FILTER) {
            ...
            if (requestURI.contains(Constants.LOGIN_PAGE) || 
                ...
                if (loginController.isLoggedIn()) {
                    ...
                    requestURI.contains(Constants.USER_MANAGE_PAGE) ||
                    requestURI.contains(Constants.TRANS_MANAGE_PAGE) ||
                    requestURI.contains(Constants.EDIT_USER_PAGE) ||
                    requestURI.contains(Constants.ADD_ITEM_PAGE) ||
                    requestURI.contains(Constants.EDIT_ITEM_PAGE)) { // other page needs login
                if (loginController.isLoggedIn()) {
