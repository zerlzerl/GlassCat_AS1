 ...
 */
package glasscat.as1.dao.service;
...
//        userPath = userPath.substring(5);
        try {
            ...
            for (Object u : users){
                ...
                String hashedpassword = SHAUtil.toHexString(SHAUtil.getSHA(password + salt));
...
//        cartDao.findAll();
        ...
        initializedFlag.setConfigValue("TRUE");
    ...
    public boolean isInitialized(){
        ...
        if (configs != null && !configs.isEmpty()) {
            String initializedFlag = configs.get(0).getConfigValue();
